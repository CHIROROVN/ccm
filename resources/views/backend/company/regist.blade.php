...
<div id="content-header">
  <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ route('backend.company.index') }}">Companies</a> <span class="current">&nbsp;&nbsp;Add Company</span> </div>
    <!--<h1>New Company</h1>-->
</div>
           ...
           <div class="widget-content nopadding">
              ...
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  ...
                  <div class="controls"><input id="company_name" type="text" name="company_name" value="{{old('company_name')}}" class="span6"/></div>
                </div>
                <div class="control-group">
                  <label class="control-label">Company Address</label>
                  <div class="controls"><input id="company_address" type="text" name="company_address" value="{{old('company_address')}}" class="span6"/></div>
                </div>
                <div class="control-group">
                  <label class="control-label">Company MST</label>
                  <div class="controls"><input id="company_mst" type="text" name="company_mst" value="{{old('company_mst')}}" class="span6"/></div>
                </div>               
              </div>
