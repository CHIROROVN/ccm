<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Company</a>
  <ul>
    ...
    <li class="submenu"><a href="#"><i class="icon icon-info-sign"></i> <span>Company</span> </a>
      <ul>
        <li><a href="#">Company List</a></li>
        <li><a href="#">Company Regist</a></li>
      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="icon icon-info-sign"></i> <span>Contract</span></a>
      <ul>
        <li><a href="#">Contracts List</a></li>
        <li><a href="#">Contract Regist</a></li>
      </ul>
    </li>
    <li class="submenu"> <a href="{{route('backend.users.index')}}"><i class="icon icon-info-sign"></i> <span>Users</span> </a>
      <ul>
